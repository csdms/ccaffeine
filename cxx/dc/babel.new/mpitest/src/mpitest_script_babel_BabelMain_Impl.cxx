// 
// File:          mpitest_script_babel_BabelMain_Impl.cxx
...
// 
// 
#include "mpitest_script_babel_BabelMain_Impl.hxx"
...
#endif
#line 39 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
// DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._includes)
...
*/
void
mpitest::script::babel::BabelMain_impl::setParamsFromString(gov::cca::TypeMap & tm, std::map< std::string, std::string > & values)
{
...
::gov::cca::Type 
mpitest::script::babel::BabelMain_impl::typeFromString( const ::std::string &typeName)
{
	REFIX(NoType,"NoType");
	REFIX(Int,"Int");
	REFIX(Long,"Long");
...
*/
void mpitest::script::babel::BabelMain_impl::transformString(const ::std::string & key,
		::gov::cca::Type dt,
...
#if 0
int mpitest::script::babel::BabelMain_impl::putValueByStrings( ::gov::cca::TypeMap t, const ::std::string & key, const ::std::string &vtype, const ::std::string & val)
{
	if (!t || key.size() == 0) { return -1; }
	::gov::cca::Type kt = typeFromString(vtype); 
	if (kt ==  ::gov::cca::Type_NoType) { return -1; }
	try {
		mpitest::script::babel::BabelMain_impl::transformString( key, kt, val, t);
		return 0;
	}
...
//---------------------------------------------------------- 
const ::std::string 
mpitest::script::babel::BabelMain_impl::typeToName( ::gov::cca::Type t) { 
	switch(t) 
	{
...
//
::std::string 
mpitest::script::babel::BabelMain_impl::stringType( ::gov::cca::TypeMap t, const ::std::string &key)
{
	if (!t) {
		return "";
	}
	enum ::gov::cca::Type kt = t.typeOf(key);
	return mpitest::script::babel::BabelMain_impl::typeToName(kt);
}
...
::std::string 
mpitest::script::babel::BabelMain_impl::stringValue( ::gov::cca::TypeMap t, const ::std::string &key)
{
	::std::string s;
	if (!t) { return s; }
...
void 
mpitest::script::babel::BabelMain_impl::dumpTypeMapStdout(::gov::cca::TypeMap t)
{
	std::vector< std::string > keys = t.getAllKeys( ::gov::cca::Type_NoType );
	std::sort(keys.begin(), keys.end());
	for (size_t i = 0; i < keys.size(); i++) {
		::std::cout << "["<< keys[i] << "](" <<
		       	mpitest::script::babel::BabelMain_impl::stringType(t,keys[i]) << ") " <<
			mpitest::script::babel::BabelMain_impl::stringValue(t,keys[i]) << std::endl;
	}
}
#endif 

// DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._includes)
#line 298 "src/mpitest_script_babel_BabelMain_Impl.cxx"

// speical constructor, used for data wrapping(required).  Do not put code here unless you really know what you're doing!
mpitest::script::babel::BabelMain_impl::BabelMain_impl() : 
  StubBase(reinterpret_cast< 
  void*>(::mpitest::script::babel::BabelMain::_wrapObj(this)),false) ,
  _wrapped(true){ 
#line 302 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._ctor2)
  // Insert-Code-Here {mpitest.script.babel.BabelMain._ctor2} (ctor2)
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._ctor2)
#line 309 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}

// user defined constructor
void mpitest::script::babel::BabelMain_impl::_ctor() {
#line 309 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._ctor)
  // add construction details here
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._ctor)
#line 318 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}

// user defined destructor
void mpitest::script::babel::BabelMain_impl::_dtor() {
#line 316 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._dtor)
  // add destruction details here
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._dtor)
#line 327 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}

// static class initializer
void mpitest::script::babel::BabelMain_impl::_load() {
#line 323 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._load)
  // Insert-Code-Here {mpitest.script.babel.BabelMain._load} (class initialization)
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._load)
#line 336 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}
 ...
 */
int32_t
mpitest::script::babel::BabelMain_impl::invokeGo_impl (
...
{
#line 342 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain.invokeGo)
	...
	return result;
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain.invokeGo)
#line 379 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}
 ...
 */
void
mpitest::script::babel::BabelMain_impl::setParameters_impl (
  /* in */const ::std::string& component,
  /* in */const ::std::string& port,
  /* in */::gov::cca::ComponentID c,
  /* in */::gov::cca::ports::BuilderService bs,
...
{
#line 393 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain.setParameters)
  ...
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain.setParameters)
#line 481 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}
 ...
 */
::std::string
mpitest::script::babel::BabelMain_impl::getParameterValue_impl (
  /* in */::gov::cca::ComponentID c,
  ...
  /* in */::gov::cca::ports::BuilderService bs ) 
{
#line 480 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain.getParameterValue)
  ...
  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain.getParameterValue)
#line 575 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}
 ...
 */
void
mpitest::script::babel::BabelMain_impl::driverBody_impl (
  /* inout */::gov::cca::AbstractFramework& af ) 
{
#line 568 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
  // DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain.driverBody)
	gov::cca::TypeMap dummy;
	dummy = af.createTypeMap();

	gov::cca::ports::BuilderService bs, dummybs;
	mpitest::script::babel::PrivateRepository pr;
	pr = mpitest::script::babel::PrivateRepository::_create();
	pr.initialize();

	gov::cca::Services services;
	// set the script up as a component in the frame it receives.
	services = af.getServices("mpitest_script_babel_BabelMain", "mpitest_script_babel_BabelMain", dummy);
	...
	services.addProvidesPort(pr, "mpitest_script_babel_PrivateRepository", "ccaffeine.ports.ComponentFactory", dummy);
...
#include "mpitest_script_babel.BabelMain.driverBody.guts.hh"
	...
	services.removeProvidesPort("mpitest_script_babel_PrivateRepository");
	// remove ourselves from the frame.
	af.releaseServices(services);


  // DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain.driverBody)
#line 633 "src/mpitest_script_babel_BabelMain_Impl.cxx"
}


#line 618 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.new/mpitest/src/mpitest_script_babel_BabelMain_Impl.cxx"
// DO-NOT-DELETE splicer.begin(mpitest.script.babel.BabelMain._misc)
// Put miscellaneous code here
// DO-NOT-DELETE splicer.end(mpitest.script.babel.BabelMain._misc)
#line 641 "src/mpitest_script_babel_BabelMain_Impl.cxx"
