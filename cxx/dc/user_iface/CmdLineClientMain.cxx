...
#ifdef _CCAMPI
static char id[]=
"main() $Id: CmdLineClientMain.cxx,v 1.28 2009/02/03 21:48:52 baallan Exp $ build with MPI";
#else
static char id[]=
"main() $Id: CmdLineClientMain.cxx,v 1.28 2009/02/03 21:48:52 baallan Exp $ build without MPI";
#endif
#endif
...
int main(int argc, char **argv) {
  ...
  stp_init(argc, argv);
#endif
  BabelStaticFactory bsf; // init mpi 
  StaticFactory *sf = &bsf;
  cl->main(argc, argv, sf);
#ifdef MPI_wrapper_HAS_COMM
  if (cl->getUseMPI()) {
