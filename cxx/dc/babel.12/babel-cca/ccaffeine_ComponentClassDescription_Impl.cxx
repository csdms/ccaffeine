...
// 
// 
#include "ccaffeine_ComponentClassDescription_Impl.hxx"
...
throw () 
{
...
#endif
    if (opaque_CCDescription_addr == 0) {
#ifdef CCAFE_AUDIT
  ...
  occd_addr = 
    static_cast< ::ccafeopq::ComponentClassDescription_shared * >(opaque_CCDescription_addr);
  occd = *occd_addr;
