// 
// File:          test_script_babel_BabelMain_Impl.hxx
...
#ifndef included_test_script_babel_BabelMain_Impl_hxx
#define included_test_script_babel_BabelMain_Impl_hxx
...
#endif
#ifndef included_test_script_babel_BabelMain_hxx
#include "test_script_babel_BabelMain.hxx"
#endif
...
#line 52 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.12/test/src/test_script_babel_BabelMain_Impl.hxx"
// DO-NOT-DELETE splicer.begin(test.script.babel.BabelMain._hincludes)
#include <map>
#include <string>
// arg FIXME; should not need to do the next
#include "gov_cca.hxx"
// DO-NOT-DELETE splicer.end(test.script.babel.BabelMain._hincludes)
#line 60 "src/test_script_babel_BabelMain_Impl.hxx"
...
namespace test { 
  namespace script { 
    namespace babel { 
      ...
      /**
       * Symbol "test.script.babel.BabelMain" (version 0.0)
       */
      class BabelMain_impl : public virtual ::test::script::babel::BabelMain 
#line 67 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.12/test/src/test_script_babel_BabelMain_Impl.hxx"
      // DO-NOT-DELETE splicer.begin(test.script.babel.BabelMain._inherits)
      // Insert-Code-Here {test.script.babel.BabelMain._inherits} (optional inheritance here)
      // DO-NOT-DELETE splicer.end(test.script.babel.BabelMain._inherits)
#line 74 "src/test_script_babel_BabelMain_Impl.hxx"
      {
...
#line 76 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.12/test/src/test_script_babel_BabelMain_Impl.hxx"
    // DO-NOT-DELETE splicer.begin(test.script.babel.BabelMain._implementation)
    ...
    // DO-NOT-DELETE splicer.end(test.script.babel.BabelMain._implementation)
#line 101 "src/test_script_babel_BabelMain_Impl.hxx"
      ...
      public:
        ...
        // (fixes bug #275)
        BabelMain_impl( struct test_script_babel_BabelMain__object * s ) : 
...
#line 192 "/home/baallan/cca/build/dccafe-99/cxx/dc/babel.12/test/src/test_script_babel_BabelMain_Impl.hxx"
// DO-NOT-DELETE splicer.begin(test.script.babel.BabelMain._hmisc)
// Put miscellaneous things here...
// DO-NOT-DELETE splicer.end(test.script.babel.BabelMain._hmisc)
#line 203 "src/test_script_babel_BabelMain_Impl.hxx"
