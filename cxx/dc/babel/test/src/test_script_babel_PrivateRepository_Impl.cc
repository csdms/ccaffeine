...
void test_script_babel::PrivateRepository_impl::_load() {
  // DO-NOT-DELETE splicer.begin(test_script_babel.PrivateRepository._load)
  // Insert-Code-Here {test_script_babel.PrivateRepository._load} (class initialization)
  // DO-NOT-DELETE splicer.end(test_script_babel.PrivateRepository._load)
}
