...
// 
// 
#include "ccaffeine_ports_ParameterPortFactoryWrap_Impl.hh"
...
throw () 
{
  ...
  if (ccafeopq_ports_ParameterPortFactory_star == 0) {
    IO_dn1("ccaffeine::ports::ParameterPortFactoryWrap_impl init given null.");
  }
#endif
  oppf =
    static_cast< ::ccafeopq::ports::ParameterPortFactory *>(ccafeopq_ports_ParameterPortFactory_star);
...
throw () 
{
  ...
  IO_dn1("ccaffeine::ports::ParameterPortFactoryWrap_impl: addPP cS ok");
    ...
    ccaffeine::Services cs = services;
